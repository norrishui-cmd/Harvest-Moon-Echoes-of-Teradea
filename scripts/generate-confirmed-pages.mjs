...
<header class="site-header"><a class="brand" href="${prefix}"><span class="brand-mark">HM</span><span class="brand-copy"><span class="brand-title">Harvest Moon: Echoes of Teradea</span><span class="brand-subtitle">Wiki &amp; Guides</span></span></a><nav class="nav" aria-label="Primary navigation"><a href="${prefix}release-date/">Release</a><a href="${prefix}platforms/">Platforms</a><a href="${prefix}features/">Features</a><a href="${prefix}locations/">Locations</a><a href="${prefix}faq/">FAQ</a></nav></header>
